...
export default function SpookyBackground({ phase = 'night' }) {
  // Safe check: If phase includes 'day', it's Day. Otherwise, it's Night.
  const isNight = typeof phase === 'string' ? !phase.includes('day') : true;
  ...
  return (
    <div className={`scene-wrapper ${themeClass}`}>
      <div className="sky">
        ...
        {/* Pivots for the perfect C-Shape Arc */}
