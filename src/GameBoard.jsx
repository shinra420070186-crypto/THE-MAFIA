...
import SpookyBackground from './SpookyBackground';
...
export default function GameBoard() {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-auto transition-opacity duration-700 ease-in-out bg-[#050505]" style={{ opacity: isGalaxyPhase ? 1 : 0, zIndex: isGalaxyPhase ? 10 : -50, visibility: isGalaxyPhase ? 'visible' : 'hidden' }}>
        <MemoizedGalaxy />
      </div>
